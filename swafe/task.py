class DecisionTask(object):
    def __init__(self, task_json):
        ...
        if last_event['eventType'] == 'WorkflowExecutionStarted' and task_json['taskToken'] not in self.history:
            self.input = last_event['workflowExecutionStartedEventAttributes']['input']
            ...
            self.completed_activity = task_json['events'][completed_activity_id]['activityTaskScheduledEventAttributes']['activityType']['name']
            self.input = last_event['activityTaskCompletedEventAttributes'].get('result')
...
class ActivityTask(object):
    def __init__(self, task_json):
        ...
        self.activity_name = task_json['activityType']['name']
